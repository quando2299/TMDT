...
const AboutUs = ({ history }) => {
  ...
  return (
    <>
      <Helmet>
        <title>Nike shop | About us</title>
        <meta
          name="description"
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="banner-section">
                <img
                  src={`${process.env.PUBLIC_URL}/assets/images/banner/about-us.jpg`}
                  alt="about-us"
                  className="img-fluid"
                />
              </div>
            ...
            <div className="col-sm-12">
              <h4>
                An uncompromising effort to exceed expectations. An incredible
                focus on the customers needs. The most competitive pricing you
                can find online.
              </h4>
              <p>
                Nike shop is a leading fashion retailer in watches, sneakers,
                backpacks. We also sell jewelry, crystal, and apparel.
              </p>
              <p>
                Nike shop believes that everyone should be able to wear what
                they love, and do so at the right price. Our incredible platform
                allows shoppers to quickly and easily find exactly what they
                want from over 650 world renowned brands and 75,000 unique
                items. We pride ourselves on our ability to deliver the best
                prices, most varied selection, and finest customer service.
                Throughout the past three decades we’ve committed to innovation
                in both the fashion and technological landscape. Our goal has
                and always will be to earn the trust and satisfaction of our
                customers. Our customer service specialists are always ready to
                assist, and our state of the art New York City fulfillment
                center is always capable of swiftly delivering products to over
                150 countries. Should you have any comments or questions, we are
                available to assist via phone, live chat or email! Remember, all
                transactions are digitally encrypted using the latest
